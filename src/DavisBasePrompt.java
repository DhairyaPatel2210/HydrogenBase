...
public class DavisBasePrompt {
	...
	static String prompt = "hydrogenSQl> ";
	static String version = "v1.0";
	static String copyright = "Team Hydrogen";
	...
	public static void splashScreen() {
		...
		System.out.println("Welcome to HydrogenBase");
		System.out.println("HydrogenBase Version " + getVersion());
	...
	public static void help() {
		...
		out.println("CREATE INDEX ON <table_name> (col_name)");
